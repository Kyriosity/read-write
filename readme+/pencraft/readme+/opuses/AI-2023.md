...
There's unadvertised human assistance and intervention behind many AI processes (either individual or by thousands in low-rate offshore). Do you remember machine learning of [Mechanical Turk](https://en.wikipedia.org/wiki/Mechanical_Turk)?
...
Computers got thinner and gradually spread from science calculations to business (with a much greater audience). Operating Systems grew into an independent phenomenon. Programming had got much more human interface (for devs and users) and programs could be portable.

Robotics delivered funny androids.
