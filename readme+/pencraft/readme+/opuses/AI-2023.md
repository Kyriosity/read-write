...
In the hottest on record 2023 artificial intelligence is on trend again. Nobody will dodge this "IntelliSteamPunk" festival - _AI_ and _GPT_ are in every other lecture, article, or product release.
...
* _Sam Altman,_ [on/off] CEO of OpenAI:\
...
The progress of computing powers allowed _assisted mathematical proofs_, impossible before. However, no AI with all the processers in the world can solve an open mathematical problem&nbsp;<sup>:1234:</sup>. Humans do.&nbsp;<sup>:scientist:</sup>
...
**AI** now is a good old _deus ex machina_ as expectation, publicity of all kinds (much viral) as means, and an overhype of IT potentials<sup>:hammer_and_wrench:</sup> as realitty. (Compare to hash functions on pure math, which had silently revolutionalized IT  before the blockchain boom.)

Math/phys theory and research behind "AI" (neural networks, quantum mechanics. lingua models) and rising computing powers aren't magic but the hard work of collective natural intelligence.
...
Robotics delivered funny androids. Programs could support a kind of console dialog for consulting or entertainment (that time smart).
