...
In the hottest on record 2023, nobody will dodge the "IntelliSteamPunk" festival... **AI**, on trend again, is in every other lecture, article, or product release.
...
**AI** now is a good old _deus ex machina_ as comprehension, publicity of all kinds (much viral) in practice, and an overhype of IT potentials<sup>:hammer_and_wrench:</sup> as reality. (Compare to hash functions on pure math, which had silently revolutionalized IT long before the blockchain boom.)

The advanced math-phys and research behind "AI" (neural networks, quantum mechanics. lingua models) and rising computing powers aren't magic but the hard work of natural intelligence.
