...
You can think up a **:canada:**:parking::razor::switzerland::a:, which a diligent fellow will unweave but Internet-connected AI-bot may only exhaust (unless you limit attempts). One can write unique text, image, or script that others will select in search results and quote.&nbsp;<sup>🦉</sup>
...
Driving is a vivid subject of automation, done almost to the whole extent - no _deus ex machina_ (aka autopilot level&nbsp;5) appeared to handle the small remainder of less obvious hazards<sup>🤖</sup>. And this after millions of miles of "learning" in real traffic.
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<sup>🦉</sup> <sub>The use of GPT bots...</sub>\
