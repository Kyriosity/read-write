...
In the hottest on record 2023 _Artificial Intelligence_ is on trend again. Nobody will dodge this "IntelliSteamPunk" festival - every other lecture, article, or product release is AI-stamped.
...
"Supervised machine learning" shades significant human assistance and intervention behind many AI processes (either individual or by thousands in low-rate offshore). if promoters of [Mechanical Turk](https://en.wikipedia.org/wiki/Mechanical_Turk) could knew this term.
...
A side-effect of that kick were amateur pseudo-sciences like _the theory of inventive problem-solving_.
___
