...
Artificial Intelligence is on trend, again, and you can't dodge this "IntelliPunk" festival - it's in every other lecture, article, or product release.
...
You can think up a CAPTCHA, which a diligent fellow will promptly pass but "AI" (with Internet access) may only exhaust unless you limit attempts.

The progress of computing powers allowed assisted mathematical proofs, impossible before. However, no AI with all the computing power in the world can solve an open mathematical problem&nbsp;<sup>:1234:</sup>. Some humans do.&nbsp;<sup>:scientist:</sup>
...
There's unadvertised human assistance and intervention behind many AI processes (either individual or by thousands in low-rate offshore). That reminds the machine learning of [Mechanical Turk](https://en.wikipedia.org/wiki/Mechanical_Turk).
...
Grunting "again"<sup>:top:</sup> obliges me to recall a few AI booms, impromptu and without wiki. I skip old fiction (such as Timber Intelligence of Pinocchio) and the times when man humanized mechanical or electrical breakthroughs, and would resume on the digital era.
...
In chess, with its intellectual aura, programs could give winning hints (not for cheat but experiment) that grandmasters couldn't discern and attributed to the abrupt progress of their inferior opponents.&nbsp;<sup>:game_die:</sup>
