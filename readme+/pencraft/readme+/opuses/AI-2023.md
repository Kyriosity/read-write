...
**AI** now is a good old _deus ex machina_ as expectation, publicity of all kinds (much viral) as means, and an overhype of IT potentials<sup>:hammer_and_wrench:</sup> as effect. (Compare to hash functions on pure math, which had silently revolutionalized IT long before the blockchain boom.)
