...
Driving is a vivid subject of automation, done almost to the whole extent, but no _deus ex machina_ happened to handle the small remaining % of traffic hazards<sup>🤖</sup>. _Full auto-pilot_ is a decade still "next year", while authorities suspend robo-taxis (where safety matters).
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<sup>🤖</sup> <sub>Not teething troubles after billions spent and some researches dropped.</sub>
