...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<sup>🦜</sup> <sub>The term coined by Emily M.&nbsp;Bender _et al_ in "On the Dangers of Stochastic Parrots: Can Language Models Be Too Big?".</sub>\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<sup>🦜</sup><sup>👤</sup> <sub>See also [Parrots are not stochastic and neither are you](https://www.content-technologist.com/stochastic-parrots/) by Arikia Millikan.</sub>
...
The progress of computing powers allowed _assisted mathematical proofs_, impossible before. However, no artificial sentience with all the processors in the world can solve an open mathematical problem&nbsp;<sup>:1234:</sup>. Humans do.&nbsp;<sup>:scientist:</sup>
...
Robotics delivered funny androids. Programs could support a kind of console dialog for consulting or entertainment (some saw sparks of intelligence already there).
