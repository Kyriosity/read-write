...
**AI** is conceptually a _deus ex machina_, (viral) publicity of all kinds in practice and an overhype of new possibilities<sup>:hammer_and_wrench:</sup>. Compare to hash functions on pure math which had silently revolutionalized IT long before the blockchain boom.

The advanced math and proven science behind "AI" (e.g. artificial neural networks), and rising computing powers are not magic but the hard work of natural intelligence.
