...
Experienced in IT will confirm that


<p dir="rtl">,Code in English<br/>,comment in Latin<br/>,document en français<br/>
but think in 3D diagrams</p>

## Recording ⏺️ design ⏹️

[Quality code](../QA/) NAMING and CAT reads well, peculiarly when a well-thought-of test plan guides the investigators. And nothing is better for reverse engineering than source code. 
