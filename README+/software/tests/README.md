...
<p>Test projects don't contribute to product value but have the same essential as the core code. </p>
...
Gettubg started with testing is a no-brainer:
...
Templates, tests doubles for missing functionality, data mocks (like pseudo-production data), and end-device smulation.
