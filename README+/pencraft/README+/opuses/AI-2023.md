...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<sup>🤖</sup> <sub>Auto-pilot _level&nbsp;5_ is a decade still "next year", and big names (as Uber) drop multi-billion research. Not teathing problems.</sub>

## Conclusion

 «AI» overhypes potential IT and credits its groundbreaking products<sup>:hammer_and_wrench:</sup> with self-learning.
 
PROTAGONOTS take the synergism of natural intelligence<sup>🧑‍🔬</sup>, put it on the rising computing powers, and wrap with a gloss of HQ videos, 3D presentations, and splendid speeches.
