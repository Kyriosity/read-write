...
You can think up a **:canada:**:parking::razor::switzerland::a:, which a diligent fellow will unweave but Internet-connected AI-bot may only exhaust (unless you limit attempts). The same fella may create unique text, image, or script that others (including GPT) will pick in search results to quote.&nbsp;<sup>👓</sup>
