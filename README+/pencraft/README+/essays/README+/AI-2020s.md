...
You can think up a **🇨🇦**🅿️🪒🇨🇭🅰️, which a diligent person will untwist but Internet-connected AI-bot may only exhaust (unless you limit attempts)<sup>💫</sup>. The same fellow may create unique text, image, or script that GPT will pick in search results to quote.<sup>👓</sup>
...
> High-level languages (FORTRAN, ALGOL), described algorithms close to usual English, and the **IF** statement (along with `GOTO`) introduced the feeling of human doubt and decision-making.

\__________________________________________ 
</details>

IT prognoses and concerns even of the most mathematician masterminds went off the scale (akin to over-optimism in space exploration). However, not everyone was on this train (like [Hubert Dreyfus](../../quotes/README+/contributors/README.md#Hubert-Dreyfus)).
