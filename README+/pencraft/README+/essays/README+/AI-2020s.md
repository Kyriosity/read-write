...
In the heat records-breaking mid-2020s _Artificial Intelligence_ is on trend again. Nobody will dodge this "IntelliSteamPunk" festival &thinsp;&mdash;&thinsp; __AI__ and __GPT__ are in every other lecture, article, or product release.[^a]

[^a]: Said not for the effect: In 2024, I hardly found a non-AI item in the Digital Festival program to land in the ChatGPT-improvised TDD lesson.
