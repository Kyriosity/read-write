...
Much of today's hits are remakes from that generation, e.g. GPT's roots in generative literature of that time.\
...
The bottom line is that the low tide left some wholesome paradigms, such as _object-oriented programming_ founded by AI approach.
