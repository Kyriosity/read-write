...
IBM PC users remember (or not) that it was a time and a <b>word</b> &mdash; not Microsoft's one or WordPerfect, but «<mark><b>Lotus</b></mark>», a synonym for spreadsheet, text processor, calendar, E-Mail client, and collaboration tools.
...
Nevertheless, it delivered the next software generation (as a product and API), was deprived of many inherent vices of the Lotus pioneer, and began to supersede _LN_ in one-way traffic gradually. 
